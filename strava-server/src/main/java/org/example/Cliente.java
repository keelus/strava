...
public class Cliente {
    ...
    public static void main(String[] args) {
        try {
            ...
            IAuthController authController = (IAuthController) registry.lookup("authController");
            IRetoController retoController = (IRetoController) registry.lookup("retoController");
